  ...
  shinyUI(shinydashboard::dashboardPage(
    ...
    shinydashboard::dashboardSidebar(
      shinydashboard::sidebarMenu(
        ...
        # Patient -------------------------------------------
        menuItem("Analyses by patient", startExpanded = T,
        ...
        # All ------------------------------------------------
        menuItem("Meta-Analyses", startExpanded = F,
                 
                 column(1,h4("Dataset :", style="color:white")),br(),br(),
                 box(width = 12,awesomeRadio(inputId = "Dataset_Type", label = "Type : ", choices = c("All", "B"), selected = "All", inline = F, checkbox = TRUE)),br(),br(), #"BT"
                 box(width = 12,awesomeRadio(inputId = "Dataset_Condition",label = "Condition : ",choices = c("Post-greffe","Pré-greffe-Excipient"),selected = "Post-greffe",inline = F,checkbox = TRUE)),br(),br(),br(),br(),br(),#br(),br(),br(),br(),br(),br(),br(),br(), #"All", "Pré-greffe", ,"RCHOP"
